...
colors = {
  'leftShoulder&rightShoulder': 'rgb(229,115,115)',
  'leftHip&rightHip': 'rgb(149,117,205)',
  'leftShoulder&leftElbow': 'rgb(255,183,77)',
  'leftElbow&leftWrist': 'rgb(255,241,76)',
  'leftShoulder&leftHip': 'rgb(240,98,146)',
  'leftHip&leftKnee': 'rgb(174,213,129)',
  'leftKnee&leftAnkle': 'rgb(174,213,129)',
  'rightShoulder&rightElbow': 'rgb(79,195,247)',
  'rightElbow&rightWrist': 'rgb(77,182,172)',
  'rightShoulder&rightHip': 'rgb(229,115,115)',
  'rightHip&rightKnee': 'rgb(77,208,225)',
  'rightKnee&rightAnkle': 'rgb(77,208,225)'
}
...
function drawSkeleton(keypoints, minConfidence, ctx, scale = 1) {
  ...
  adjacentKeyPoints.forEach((keypoints) => {
    ...
    if (str2 in colors)
      paintColor = colors[str2];
    drawSegment(toTuple(keypoints[0].position),
      toTuple(keypoints[1].position), paintColor, scale, ctx);
  });
}
